...
A simple Flask web UI is included. See `WEB_UI_INSTRUCTIONS.md` for how to run it locally. In short:

1. Install Flask: `pip install flask`
2. Run: `python app.py`
3. Open http://127.0.0.1:5000 and upload an image to see the score and label.
